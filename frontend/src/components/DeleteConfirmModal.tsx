    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" onClick={e => { e.stopPropagation(); onClose(); }}>
      <div className="bg-gray-900 border border-gray-700 rounded-xl p-6 w-full max-w-md" onClick={e => e.stopPropagation()}>
        ...
        <p className="text-sm text-gray-300 mb-3">
          This will remove <span className="font-bold text-gray-100">{projectName}</span> from the dashboard. Files on disk will not be affected.
        </p>
        ...
        <label className="block text-sm text-gray-300 mb-1">
          Type <span className="font-mono font-bold text-gray-100">{projectName}</span> to confirm
        </label>
        <input
          type="text"
          value={confirmText}
          ...
          className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-sm text-gray-100 mb-4 focus:outline-none focus:border-red-500"
          autoFocus
        />
